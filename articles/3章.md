...
使用url_loader 打包图片  
打包生成了base64字符串, 图片生成了 base64 内容
...
为什么css 需要两个loader?
	...
	css-loader: 合并css代码  
	style-loader: 把样式挂在 script 标签里面
...
作用，补充浏览器不支持的es6语法，自己做 peomise 等方法的  实现
